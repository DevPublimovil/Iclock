...
<body id="login" {{-- style="background-image: url('{{asset('images/bgclock.jpg')}}'); background-size: cover; font-family: 'Poppins', sans-serif;" --}}>
        <svg viewBox="0 0 500 150" preserveAspectRatio="none" class="wave bottom-0 left-0 fixed h-full">
    ...
    <div class="container w-screen h-full grid p-8 mt-8">
        <div class="image flex items-center justify-end">
            <img src="{{ asset('images/checklist.svg') }}" alt="">
        </div>
        <div class="login-container flex  justify-center items-center text-center shadow-lg ml-8">
